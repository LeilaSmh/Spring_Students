      ...
      <div class="container">
        <div class="row justify-content-between">
          ...
          <article id="content" class="col-lg-9">
            ...
            <h1 class="h2 font-weight-light"> <b>Liste des filières</b>.</h1>
            ...
            <section id="section-4">
              <h2 class="section-title">Filières <a data-scroll="" href="${pageContext.request.contextPath}/dashboard/filiere/showForm" class="anchor" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ajouter Filiere"></a></h2>
              <div class="row">
                <div class="col">
                    ...
                    <tbody>
				      ...
				      <c:forEach var="tempFiliere" items="${filieres}">
				       ...
				       <tr>
				        ...
				        <td>
				         <!-- display the update link --> <a style="padding: 0.25em 0.25em" class="" href="${updateLink}"><i class="icon-edit"></i></a>
				          <a class="" href="${deleteLink}"
				         onclick="if (!(confirm('confirmer la suppression ?'))) return false"><i class="icon-trash"></i></a>
				        </td>
				       </tr>
				      </c:forEach>
