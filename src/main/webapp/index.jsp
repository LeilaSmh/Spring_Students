      ...
      <div class="container">
        <div class="row justify-content-between">
            ...
            <div class="sticky sticky-with-header" style="">
              ...
              <div class="overlay-menu boxed bg-dark text-white mb-3 mb-lg-0">
                ...
                <security:authorize access="!hasRole('GUEST')">
	                <ul id="page-nav" class="nav flex-column nav-vertical">
	                  <li class="nav-item">
	                    <a class="nav-link" href="${pageContext.request.contextPath}/auth/login"  role="button" aria-expanded="true" style="">Login</a>  
	                  </li>
	                  <li class="nav-item">
	                    <a class="nav-link" href="${pageContext.request.contextPath}/auth/register"  role="button" aria-expanded="true" style="">Register</a>  
	                  </li>
	                 </ul>
                </security:authorize>
              </div>
          ...
          <article id="content" class="col-lg-7">
			<security:authorize access="!hasRole('GUEST')">
            <h1 class="h2 font-weight-light"> <b>Bienvenu,</b> Veuillez vous connecter pour utiliser notre site.</h1>
			</security:authorize>
			<security:authorize access="hasRole('GUEST')">
				<h1 class="h2 font-weight-light"> <b>Bienvenu,</b> sur notre plateforme</h1>
			</security:authorize>
